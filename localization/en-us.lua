    ...
    Back =
    {
        ...
        b_roff_highscoring = {
            ...
            text = {
                ...
                "{E:1,C:inactive,s:0.67}Welcome back to another high-scoring run...",
                "{C:inactive,s:0.61}By the way, win Ante 1 to reset the jokers.",
                "{C:inactive,s:0.55}Some of you can't have fun..."
            },
        },
    },
    Mod = 
